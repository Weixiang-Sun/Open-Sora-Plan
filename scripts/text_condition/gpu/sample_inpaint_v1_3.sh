...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 torchrun --nnodes=1 --nproc_per_node 8 --master_port 29513 \
    ...
    --model_type "inpaint" \
    --model_path /mbz/users/zhengqing.yuan/weixiang/model/Open-Sora-Plan-v1.3.0/any93x640x640 \
    --version v1_3 \
    --num_frames 93 \
    --height 352 \
    --width 640 \
    ...
    --text_prompt examples/{$expname}_prompt.txt \
    --conditional_pixel_values_path examples/cond_pix_path.txt \
    --ae WFVAEModel_D8_4x8x8 \
    --ae_path "/mbz/users/zhengqing.yuan/weixiang/model/Open-Sora-Plan-v1.3.0/vae" \
    --save_img_path "./$expname" \
    --fps 18 \
    --guidance_scale 7.5 \
